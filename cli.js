...
const argv = parseArgs(`snarkjs <command> <options>
...
==================================
    ...
    -v or --verifier
        ...
        Output file with a solidity smart contract that verifies a zero knowlage
        proof.
...
Copyright (C) 2018  0kims association
    ...
    { full: 'circuit', short: 'c' }, 
    { full: 'provingkey', short: 'pk' }, 
    { full: 'verificationkey', short: 'vk' },
    { full: 'witness', short: 'w' },
    { full: 'proof', short: 'p' },
    { full: 'input', short: 'i' },
    { full: 'public', short: 'pub' },
    { full: 'verifier', short: 'v' },
    { full: 'logoutput', short: 'lo' },
    { full: 'logget', short: 'lg' },
    { full: 'logset', short: 'ls' },
    { full: 'logtrigger', short: 'lt' },
    { full: 'protocol' },
);
